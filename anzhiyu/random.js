var posts=["2024/05/07/hello-world/","2024/05/05/【pytorch学习】之数据操作/","2024/05/07/搭建自己的博客/","2024/05/05/机器学习（-数据科学）的工作流程/","2024/05/05/python/关于python中if-name-main-的理解/","2024/05/08/python/第-1-章-Python-爬虫概念与-Web-基础/"];function toRandomPost(){
